wordEater.gameOptions = (function() {
/////////////////////////////////////////////////
	function handleReturnBtnDown() {
		scene.scene.stop(wordEater.getGameOptionsId())
		scene.scene.start(wordEater.getGameTitleId())
	}
	
	// public accessible
	var scene = fn_createScene(wordEater.getGameOptionsId());
	scene.init = function() {
        ...
        this.musicOn = wordEater.isMusicOn();  
        this.controlOn = wordEater.isMobileControlOn();
	};
	...
	scene.preload = function() {		
		...
		this.load.image(this.checkedCheckboxId, wordEater.getAsset("checkedCheckbox.png"));
		this.load.image(this.uncheckedCheckboxId, wordEater.getAsset("uncheckedCheckbox.png"));
	};
	...
	scene.updateOptions = function() {
	    ...
	    wordEater.setMusicOn(this.musicOn);
    	...
    	wordEater.setMobileControlOn(this.controlOn);
