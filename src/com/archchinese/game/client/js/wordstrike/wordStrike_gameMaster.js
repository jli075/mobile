...
wordStrike.gameMaster = (function(){
	//private section
	function config(){//private function
		...
		conf.scene.push(wordStrike.gameTitle);
		conf.scene.push(wordStrike.gameHelp);
		conf.scene.push(wordStrike.gameOptions);
		conf.scene.push(wordStrike.gameGlass);
		conf.scene.push(wordStrike.gameScene1);
		conf.scene.push(wordStrike.gameOver);
	...
	gameAgent.setMainGameScene(wordStrike.gameScene1);
	gameAgent.setGameOverScene(wordStrike.gameOver);
