...
tarsiaPuzzle.gameGlass = (function() {
/////////////////////////////////////////////////	
	// public accessible
	var scene = fn_createScene(tarsiaPuzzle.getGameGlassId());
	scene.init = function() {
	...
	scene.resumeGame = function() {
		...
		scene.scene.resume(tarsiaPuzzle.getGameSceneOneId());
		scene.scene.get(tarsiaPuzzle.getGameSceneOneId()).enablePauseBtn();//enable pause	
	}.bind(scene);
