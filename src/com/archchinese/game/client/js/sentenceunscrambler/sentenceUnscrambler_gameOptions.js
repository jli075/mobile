sentenceUnscrambler.gameOptions = (function() {
/////////////////////////////////////////////////
	function handleReturnBtnDown() {
		scene.scene.stop(sentenceUnscrambler.getGameOptionsId())
		scene.scene.start(sentenceUnscrambler.getGameTitleId())
	}
	
	// public accessible
	var scene = fn_createScene(sentenceUnscrambler.getGameOptionsId());
	scene.init = function() {
        ...
        this.musicOn = sentenceUnscrambler.isMusicOn();
        this.soundOn = sentenceUnscrambler.isSoundOn();
        this.controlOn = sentenceUnscrambler.isAutoSpinOn();
        this.zoomInOn = sentenceUnscrambler.isZoomInOn();
	};
	...
	scene.preload = function() {		
		...
		this.load.image(this.frameImgId, sentenceUnscrambler.getAsset("frame.png"));
		this.load.image(this.checkedCheckboxId, sentenceUnscrambler.getAsset("checkedCheckbox.png"));
		this.load.image(this.uncheckedCheckboxId, sentenceUnscrambler.getAsset("uncheckedCheckbox.png"));
	};
	...
	scene.updateOptions = function() {
	    ...
	    sentenceUnscrambler.setMusicOn(this.musicOn);
	    ...
	    sentenceUnscrambler.setSoundOn(this.soundOn);
    	...
    	sentenceUnscrambler.setAutoSpinOn(this.controlOn);
    	...
    	sentenceUnscrambler.setZoomInOn(this.zoomInOn);
