...
//The Module Pattern
sentenceUnscrambler.gameMaster = (function(){
	//private section
	function config(){//private function
		...
		conf.scene.push(sentenceUnscrambler.gameTitle);
		conf.scene.push(sentenceUnscrambler.gameHelp);
		conf.scene.push(sentenceUnscrambler.gameOptions);
		conf.scene.push(sentenceUnscrambler.gameGlass);
		conf.scene.push(sentenceUnscrambler.gameScene1);
		conf.scene.push(sentenceUnscrambler.gameOver);
	...
	gameAgent.setMainGameScene(sentenceUnscrambler.gameScene1);
	gameAgent.setGameOverScene(sentenceUnscrambler.gameOver);
