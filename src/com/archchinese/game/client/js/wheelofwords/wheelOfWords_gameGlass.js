...
wheelOfWords.gameGlass = (function() {
/////////////////////////////////////////////////	
	// public accessible
	var scene = fn_createScene(wheelOfWords.getGameGlassId());
	scene.init = function() {
	...
	scene.resumeGame = function() {
		...
		scene.scene.resume(wheelOfWords.getGameSceneOneId());
		scene.scene.get(wheelOfWords.getGameSceneOneId()).enablePauseBtn();//enable pause	
	}.bind(scene);
