wheelOfWords.gameOptions = (function() {
/////////////////////////////////////////////////
	function handleReturnBtnDown() {
		scene.scene.stop(wheelOfWords.getGameOptionsId())
		scene.scene.start(wheelOfWords.getGameTitleId())
	}
	
	// public accessible
	var scene = fn_createScene(wheelOfWords.getGameOptionsId());
	scene.init = function() {
        ...
        this.musicOn = wheelOfWords.isMusicOn();
        this.soundOn = wheelOfWords.isSoundOn();
        this.controlOn = wheelOfWords.isAutoSpinOn();
        this.zoomInOn = wheelOfWords.isZoomInOn();
	};
	...
	scene.preload = function() {		
		...
		this.load.image(this.frameImgId, wheelOfWords.getAsset("frame.png"));
		this.load.image(this.checkedCheckboxId, wheelOfWords.getAsset("checkedCheckbox.png"));
		this.load.image(this.uncheckedCheckboxId, wheelOfWords.getAsset("uncheckedCheckbox.png"));
	};
	...
	scene.updateOptions = function() {
	    ...
	    wheelOfWords.setMusicOn(this.musicOn);
	    ...
	    wheelOfWords.setSoundOn(this.soundOn);
    	...
    	wheelOfWords.setAutoSpinOn(this.controlOn);
    	...
    	wheelOfWords.setZoomInOn(this.zoomInOn);
