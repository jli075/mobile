...
whackAMole.gameOver = (function() {
	var scene = fn_createScene(whackAMole.getGameOverId());
	...
	scene.create = function() {
		...
		//final score
		fn_centerObject(this, fn_createFinalScoreLabel(this, whackAMole.gameScene1.finalScore), 2);
	...
	scene.setGameLeaderboard = function(leaderboard) {		
		fn_showLeaderboard(this, leaderboard, whackAMole.gameScene1.finalScore, document);
	}.bind(scene);
