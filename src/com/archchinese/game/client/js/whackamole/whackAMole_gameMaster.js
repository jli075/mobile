...
//The Module Pattern
whackAMole.gameMaster = (function(){
	//private section
	function config(){//private function
		...
		conf.scene.push(whackAMole.gameTitle);
		conf.scene.push(whackAMole.gameHelp);
		conf.scene.push(whackAMole.gameGlass);
		conf.scene.push(whackAMole.gameScene1);
		conf.scene.push(whackAMole.gameOver);
		
		//remove gravity for whack a mole
	...
	gameAgent.setMainGameScene(whackAMole.gameScene1);
	gameAgent.setGameOverScene(whackAMole.gameOver);
