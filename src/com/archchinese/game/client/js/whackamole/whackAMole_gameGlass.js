...
whackAMole.gameGlass = (function() {
/////////////////////////////////////////////////	
	// public accessible
	var scene = fn_createScene(whackAMole.getGameGlassId());
	scene.init = function() {
	...
	scene.resumeGame = function() {
		...
		scene.scene.resume(whackAMole.getGameSceneOneId());
		scene.scene.get(whackAMole.getGameSceneOneId()).music.resume();//resume music
		scene.scene.get(whackAMole.getGameSceneOneId()).enablePauseBtn();//enable pause	
	}.bind(scene);
