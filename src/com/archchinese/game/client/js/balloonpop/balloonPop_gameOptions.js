balloonPop.gameOptions = (function() {
/////////////////////////////////////////////////
	function handleReturnBtnDown() {
		scene.scene.stop(balloonPop.getGameOptionsId())
		scene.scene.start(balloonPop.getGameTitleId())
	}
	
	// public accessible
	var scene = fn_createScene(balloonPop.getGameOptionsId());
	scene.init = function() {
        ...
        this.musicOn = balloonPop.isMusicOn();  
        this.controlOn = balloonPop.isMobileControlOn();
	};
	...
	scene.preload = function() {		
		...
		this.load.image(this.checkedCheckboxId, balloonPop.getAsset("checkedCheckbox.png"));
		this.load.image(this.uncheckedCheckboxId, balloonPop.getAsset("uncheckedCheckbox.png"));
	};
	...
	scene.updateOptions = function() {
	    ...
	    balloonPop.setMusicOn(this.musicOn);
    	...
    	balloonPop.setMobileControlOn(this.controlOn);
