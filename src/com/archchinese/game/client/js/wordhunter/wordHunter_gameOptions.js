wordHunter.gameOptions = (function() {
/////////////////////////////////////////////////
	function handleReturnBtnDown() {
		scene.scene.stop(wordHunter.getGameOptionsId())
		scene.scene.start(wordHunter.getGameTitleId())
	}
	
	// public accessible
	var scene = fn_createScene(wordHunter.getGameOptionsId());
	scene.init = function() {
        ...
        this.musicOn = wordHunter.isMusicOn();        
        this.controlOn = wordHunter.isMobileControlOn();
	};
	...
	scene.preload = function() {		
		...
		this.load.image(this.checkedCheckboxId, wordHunter.getAsset("checkedCheckbox.png"));
		this.load.image(this.uncheckedCheckboxId, wordHunter.getAsset("uncheckedCheckbox.png"));
	};
	...
	scene.create = function() {
        ...
        this.controlButtonText = this.createLabel("Enable mobile controls");
	...
	scene.updateOptions = function() {
	    ...
	    wordHunter.setMusicOn(this.musicOn);
    	...
    	wordHunter.setMobileControlOn(this.controlOn);
