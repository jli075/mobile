...
wordHunter.gameOver = (function() {
	//////////////////////////////
	var scene = fn_createScene(wordHunter.getGameOverId());
	scene.init = function() {
		//set the ids heres
	...
	scene.create = function() {
		...
		//final score
		fn_centerObject(this, fn_createFinalScoreLabel(this, wordHunter.gameScene1.score), 2);
	...
	scene.setGameLeaderboard = function(leaderboard) {		
		fn_showLeaderboard(this, leaderboard, wordHunter.gameScene1.score, document);
	}.bind(scene);
